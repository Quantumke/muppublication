...
def view_post(request):
	...
	return  render(request, 'official/displayads.html', {'ads':ads})
...
def view_more(request, slug):
	return render_to_response('official/viewmore.html', {
...
def update_post(request, id):
		...
		return render(request, 'official/update_post.html',context)
...
def archive_post(request, id):
	...
	return render(request, 'official/viewmore.html', context)
...
def viewpost(request):
	return render_to_response('official/index.html',{
		'posts': news_posts.objects.all().order_by('-posted_on')[:10]
